...
#define BASEBAND_PART_PATH "/dev/block/bootdevice/by-name/firmware"
...
void Register_librecovery_updater_tomato() {
    RegisterFunction("tomato.verify_baseband", VerifyBasebandFn);
}
