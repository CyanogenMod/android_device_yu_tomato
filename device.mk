...
#Overlay the media_codecs_google_video.xml
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/overlay/frameworks/av/media/libstagefright/data/media_codecs_google_video.xml:system/etc/media_codecs_google_video.xml
