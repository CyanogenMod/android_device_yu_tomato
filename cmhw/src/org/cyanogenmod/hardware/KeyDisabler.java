...
public class KeyDisabler {
    ...
    private static final String KEYPAD_PATH =
            "/sys/devices/soc.0/78b9000.i2c/i2c-5/5-005d/keypad_enable";

    public static boolean isSupported() {
        return FileUtils.isFileWritable(KEYPAD_PATH) &&
                FileUtils.isFileReadable(KEYPAD_PATH);
    }

    public static boolean isActive() {
        return "0".equals(FileUtils.readOneLine(KEYPAD_PATH));
    }

    public static boolean setActive(boolean state) {
        return FileUtils.writeLine(KEYPAD_PATH, state ? "0" : "1");
    }
}
