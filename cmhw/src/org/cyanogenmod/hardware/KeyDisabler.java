...
public class KeyDisabler {
    ...
    private static final String FILE = "/sys/devices/soc.0/78b9000.i2c/i2c-5/5-005d/keypad_enable";

    public static boolean isSupported() {
        return FileUtils.isFileWritable(FILE) &&
                FileUtils.isFileReadable(FILE);
    }

    public static boolean isActive() {
        return "0".equals(FileUtils.readOneLine(FILE));
    }

    public static boolean setActive(boolean state) {
        return FileUtils.writeLine(FILE, state ? "0" : "1");
    }
}
